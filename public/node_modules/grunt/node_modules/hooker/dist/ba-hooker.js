...
(function(exports) {
  ...
  // When a pre- or posts-hook returns the result of this function, the value
  // passed will be used in place of the original function's return value. Any
  // posts-hook override value will take precedence over a pre-hook override
  // value.
  ...
  exports.hook = function(obj, props, options) {
    ...
    return forMethods(obj, props, function(obj, prop) {
      ...
      function hooked() {
        ...
        if (options.post) {
          // If a posts-hook function was specified, invoke it in the current
          ...
          if (tmp instanceof HookerOverride) {
            // If the posts-hook returned hooker.override(value), use the passed
